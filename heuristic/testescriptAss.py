...
if ( len(sys.argv) == 5 ):
    ...
    try:
        ...
        instances = ['ftv35-4-25.in', 'ftv38-4-33.in', 'ftv44-4-25.in', 'ftv47-4-33.in', 'ftv55-4-25.in', 'ftv64-4-50.in', 'p43-4-25.in', 'ry48p-4-50.in']
        ...
        dataframe.to_csv(SAVE_PATH + 'resultsAssimetrico' + '.csv', index=True, header=True, sep=',')
